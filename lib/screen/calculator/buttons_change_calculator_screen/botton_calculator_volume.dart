...
class BottomBuyCalculatorVolume extends StatefulWidget {
  const BottomBuyCalculatorVolume({Key? key, required this.toggleView}) : super(key: key);

  final Function toggleView;

  @override
  State<BottomBuyCalculatorVolume> createState() => _BottomBuyCalculatorVolumeState();
}

class _BottomBuyCalculatorVolumeState extends State<BottomBuyCalculatorVolume> {
  @override
