...
class SellInstrument extends StatefulWidget {
  ...
  String getCurrencySymbolByInstrumentType() {
    if (InstrumentTypeName == 'Валюта') {
      return utf8RUB;
    } else {
      return getCurrencySymbol(CurrencyName);
    }
  }

  @override
  State<SellInstrument> createState() => _SellInstrumentState();
}

class _SellInstrumentState extends State<SellInstrument> {
  ...
  Widget build(BuildContext context) {
    ...
    String currencySymbol = widget.getCurrencySymbolByInstrumentType();
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        if (_formKey.currentState!.validate()) {
                          final sellInstrumentService =
                          BuySellInstrumentService();
                          final statusCode = await sellInstrumentService.sellInstrument(
