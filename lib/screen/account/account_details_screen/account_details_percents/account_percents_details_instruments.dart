...
import 'package:mobile_app_diplom/services/services_for_account/services_for_account_details_screen/get_percent_instruments_for_account.dart';
...
class AccountDetailsInstrumentsPercents extends StatefulWidget {
  AccountDetailsInstrumentsPercents({Key? key}) : super(key: key);

  @override
  State<AccountDetailsInstrumentsPercents> createState() => _AccountDetailsInstrumentsPercentsState();
}

class _AccountDetailsInstrumentsPercentsState extends State<AccountDetailsInstrumentsPercents> {
  ...
  Future<void> setupInstrumentsNameAndAssentsPercentByAccount() async {
    TypeOfInstrumentsPercentByAccount instance = TypeOfInstrumentsPercentByAccount();
    await instance.getTypeOfInstrumentsPercentByAccount();
    ColorsClass;
    // print(instance.keys);
  ...
  void initState(){
    super.initState();
    setupInstrumentsNameAndAssentsPercentByAccount();
