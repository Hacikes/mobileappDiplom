...
class account_details_instruments_dashboard extends StatefulWidget {
  account_details_instruments_dashboard({Key? key}) : super(key: key);

  @override
  State<account_details_instruments_dashboard> createState() => _account_details_instruments_dashboardState();
}

class _account_details_instruments_dashboardState extends State<account_details_instruments_dashboard> {
  ...
  Future<void> setupShareInstrumentsByAccount() async {
  ...
  void initState(){
    ...
    setupShareInstrumentsByAccount();
  }
