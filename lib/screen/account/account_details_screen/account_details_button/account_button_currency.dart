...
class account_details_button_currency extends StatefulWidget {
  const account_details_button_currency({Key? key, required this.toggleView , required this.AccountIdForDetails , required this.AccountNameForDetails, required this.BrokerNameForDetails}) : super(key: key);
  ...
  @override
  State<account_details_button_currency> createState() => _account_details_button_currencyState();
}

class _account_details_button_currencyState extends State<account_details_button_currency> {
  @override
